![Sapuseo](https://i.imgur.com/0S2zIH3.png)
...
Sapuseo is an Open Source Search Engine Position Tracking and Keyword Research App. It allows you to track your website's keyword positions in Google and get notified of their position change.
...
- **SERP API:** Sapuseo comes with built-in API that you can use for your marketing & data reporting tools.
...
The Keyword Research and keyword generation feature works by integrating your Google Ads test accounts into Sapuseo. You can also view the added keyword's monthly search volume data once you [integrate Google Ads](https://docs.serpbear.com/miscellaneous/integrate-google-ads).
...
#### Sapuseo Integrates with popular SERP scraping services
